...
func NewCatalogServiceHandler(srv CatalogServiceHandler, opts ...http1.HandleOption) http.Handler {
	...
	r.HandleFunc("/v1/product/", func(w http.ResponseWriter, r *http.Request) {
	...
	r.HandleFunc("/v1/product/{id}", func(w http.ResponseWriter, r *http.Request) {
